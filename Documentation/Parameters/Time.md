...
2. Most workbook controls support a _Time Range_ scope picker. Open the the _Time Range_ drop down and select the `{TimeRange}` in the time rang parameters group at the bottom.
